...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,263 | 🐛 105 | 📅 2026-08-18
...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 313,979 | 🐛 0 | 📅 2026-08-20 on GitHub.*
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,564 | 🐛 236 | 🌐 JavaScript | 📅 2026-08-19: A linter for English prose using advice from *Garner's Modern American Usage* and more.
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 54,829 | 🐛 123 | 🌐 JavaScript | 📅 2026-08-21 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,045 | 🐛 168 | 🌐 JavaScript | 📅 2026-07-10: Overleaf open sourced their codes. This is a great move I would say.
...
* [More](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks) ⭐ 16,771 | 🐛 1,293 | 🌐 Python | 📅 2026-08-18: For more IPython notebook on GitHub please read this enormous list.
* [Scientific Python Lectures](https://github.com/jrjohansson/scientific-python-lectures) ⭐ 3,646 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-06-02
...
* [Reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,158 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21
...
* [vim](https://github.com/vim/vim) ⭐ 40,776 | 🐛 1,624 | 🌐 Vim Script | 📅 2026-08-20(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
  * [Vundle](https://github.com/VundleVim/Vundle.vim) ⭐ 23,926 | 🐛 204 | 🌐 Vim Script | 📅 2024-07-30: the vim plugin manager
  * [vimrc from amix](https://github.com/amix/vimrc) ⭐ 31,792 | 🐛 22 | 🌐 Vim Script | 📅 2024-10-06: "The ultimate Vim configuration: vimrc"
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 28,210 | 🐛 3 | 📅 2026-08-20 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 28,210 | 🐛 3 | 📅 2026-08-20 for search engines to search for papers.
