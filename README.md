...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,446 | 🐛 102 | 📅 2026-08-18
...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 313,540 | 🐛 0 | 📅 2026-08-17 on GitHub.*
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,563 | 🐛 236 | 🌐 JavaScript | 📅 2026-08-18: A linter for English prose using advice from *Garner's Modern American Usage* and more.
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 54,795 | 🐛 123 | 🌐 JavaScript | 📅 2026-08-19 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,034 | 🐛 166 | 🌐 JavaScript | 📅 2026-07-10: Overleaf open sourced their codes. This is a great move I would say.
...
* [my-mind](http://my-mind.github.io/): repo [here](https://github.com/ondras/my-mind) ⭐ 3,364 | 🐛 59 | 🌐 TypeScript | 📅 2024-06-18.
...
* [Reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,146 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21
...
* [vim](https://github.com/vim/vim) ⭐ 40,767 | 🐛 1,628 | 🌐 Vim Script | 📅 2026-08-18(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 28,157 | 🐛 2 | 📅 2026-08-18 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 28,157 | 🐛 2 | 📅 2026-08-18 for search engines to search for papers.
