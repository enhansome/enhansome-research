...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 499,936 | 🐛 106 | 📅 2026-08-21
...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 315,083 | 🐛 0 | 📅 2026-08-22 on GitHub.*
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,566 | 🐛 236 | 🌐 JavaScript | 📅 2026-08-24: A linter for English prose using advice from *Garner's Modern American Usage* and more.
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,059 | 🐛 128 | 🌐 JavaScript | 📅 2026-08-26 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,069 | 🐛 168 | 🌐 JavaScript | 📅 2026-07-10: Overleaf open sourced their codes. This is a great move I would say.
...
* [More](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks) ⭐ 16,773 | 🐛 1,293 | 🌐 Python | 📅 2026-08-25: For more IPython notebook on GitHub please read this enormous list.
...
* [Reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,189 | 🐛 908 | 🌐 JavaScript | 📅 2026-08-24
...
* [vim](https://github.com/vim/vim) ⭐ 40,800 | 🐛 1,619 | 🌐 Vim Script | 📅 2026-08-25(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
  * [vimrc from amix](https://github.com/amix/vimrc) ⭐ 31,794 | 🐛 21 | 🌐 Vim Script | 📅 2024-10-06: "The ultimate Vim configuration: vimrc"
...
* [dna-claude-analysis](https://github.com/shmlkv/dna-claude-analysis) ⭐ 56 | 🐛 0 | 🌐 Python | 📅 2026-03-04: Personal genome analysis toolkit with Python scripts analyzing raw DNA data across 17 categories and generating terminal-style HTML visualization for scientific research.
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 28,324 | 🐛 4 | 📅 2026-08-25 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 28,324 | 🐛 4 | 📅 2026-08-25 for search engines to search for papers.
