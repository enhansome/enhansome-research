...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 315,829 | 🐛 0 | 📅 2026-08-28 on GitHub.*
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,076 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-29 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,078 | 🐛 172 | 🌐 JavaScript | 📅 2026-07-10: Overleaf open sourced their codes. This is a great move I would say.
...
* [More](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks) ⭐ 16,773 | 🐛 1,279 | 🌐 Python | 📅 2026-08-28: For more IPython notebook on GitHub please read this enormous list.
...
* [vim](https://github.com/vim/vim) ⭐ 40,818 | 🐛 1,636 | 🌐 Vim Script | 📅 2026-08-29(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 28,635 | 🐛 9 | 📅 2026-08-25 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 28,635 | 🐛 9 | 📅 2026-08-25 for search engines to search for papers.
