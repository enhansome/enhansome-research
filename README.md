...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,657 | 🐛 105 | 📅 2026-08-21
...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 314,181 | 🐛 0 | 📅 2026-08-21 on GitHub.*
...
* [write good](https://github.com/btford/write-good) ⭐ 5,083 | 🐛 24 | 🌐 JavaScript | 📅 2025-03-10: Naive JavaScript linter for English prose.
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 54,893 | 🐛 127 | 🌐 JavaScript | 📅 2026-08-22 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,052 | 🐛 168 | 🌐 JavaScript | 📅 2026-07-10: Overleaf open sourced their codes. This is a great move I would say.
...
* [More](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks) ⭐ 16,773 | 🐛 1,293 | 🌐 Python | 📅 2026-08-18: For more IPython notebook on GitHub please read this enormous list.
...
* [vim](https://github.com/vim/vim) ⭐ 40,779 | 🐛 1,626 | 🌐 Vim Script | 📅 2026-08-21(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 28,236 | 🐛 3 | 📅 2026-08-20 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 28,236 | 🐛 3 | 📅 2026-08-20 for search engines to search for papers.
