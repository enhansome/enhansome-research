...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,509 | 🐛 105 | 📅 2026-08-21
...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 316,238 | 🐛 0 | 📅 2026-08-30 on GitHub.*
...
* [write good](https://github.com/btford/write-good) ⭐ 5,087 | 🐛 24 | 🌐 JavaScript | 📅 2025-03-10: Naive JavaScript linter for English prose.
* [proselint](https://github.com/amperser/proselint) ⭐ 4,572 | 🐛 236 | 🌐 JavaScript | 📅 2026-08-26: A linter for English prose using advice from *Garner's Modern American Usage* and more.
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,089 | 🐛 133 | 🌐 JavaScript | 📅 2026-08-31 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,080 | 🐛 172 | 🌐 JavaScript | 📅 2026-07-10: Overleaf open sourced their codes. This is a great move I would say.
...
* [More](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks) ⭐ 16,775 | 🐛 1,278 | 🌐 Python | 📅 2026-08-28: For more IPython notebook on GitHub please read this enormous list.
...
* [mindmaps](http://drichard.org/mindmaps/): repo [here](https://github.com/drichard/mindmaps) ⭐ 2,869 | 🐛 35 | 🌐 JavaScript | 📅 2023-02-05
...
* [mindmaps](https://github.com/drichard/mindmaps) ⭐ 2,869 | 🐛 35 | 🌐 JavaScript | 📅 2023-02-05
...
* [Reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,237 | 🐛 911 | 🌐 JavaScript | 📅 2026-08-24
...
* [vim](https://github.com/vim/vim) ⭐ 40,826 | 🐛 1,630 | 🌐 Vim Script | 📅 2026-08-30(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
  * [vimrc from amix](https://github.com/amix/vimrc) ⭐ 31,807 | 🐛 21 | 🌐 Vim Script | 📅 2024-10-06: "The ultimate Vim configuration: vimrc"
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 29,018 | 🐛 10 | 📅 2026-08-25 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 29,018 | 🐛 10 | 📅 2026-08-25 for search engines to search for papers.
