...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 320,206 | 🐛 0 | 📅 2026-09-18 on GitHub.*
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,354 | 🐛 182 | 🌐 TypeScript | 📅 2026-09-19 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,144 | 🐛 173 | 🌐 JavaScript | 📅 2026-09-17: Overleaf open sourced their codes. This is a great move I would say.
...
* [More](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks) ⭐ 16,782 | 🐛 1,291 | 🌐 Python | 📅 2026-09-14: For more IPython notebook on GitHub please read this enormous list.
...
* [Strut](https://github.com/tantaman/Strut) ⭐ 1,890 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-17
...
* [Reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,311 | 🐛 915 | 🌐 JavaScript | 📅 2026-09-18
...
* [CSSS](https://github.com/LeaVerou/CSSS) ⭐ 1,754 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-17
...
* [vim](https://github.com/vim/vim) ⭐ 40,898 | 🐛 1,625 | 🌐 Vim Script | 📅 2026-09-19(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 29,624 | 🐛 26 | 📅 2026-09-09 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 29,624 | 🐛 26 | 📅 2026-09-09 for search engines to search for papers.
