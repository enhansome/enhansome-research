...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,698 | 🐛 106 | 📅 2026-09-02
...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 320,863 | 🐛 0 | 📅 2026-09-21 on GitHub.*
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,383 | 🐛 188 | 🌐 TypeScript | 📅 2026-09-21 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,154 | 🐛 173 | 🌐 JavaScript | 📅 2026-09-17: Overleaf open sourced their codes. This is a great move I would say.
...
* [More](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks) ⭐ 16,784 | 🐛 1,292 | 🌐 Python | 📅 2026-09-14: For more IPython notebook on GitHub please read this enormous list.
...
* [Reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,333 | 🐛 915 | 🌐 JavaScript | 📅 2026-09-18
...
* [Shower](https://github.com/shower/shower) ⭐ 4,876 | 🐛 41 | 🌐 JavaScript | 📅 2026-09-21
...
* [vim](https://github.com/vim/vim) ⭐ 40,917 | 🐛 1,630 | 🌐 Vim Script | 📅 2026-09-21(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 29,673 | 🐛 0 | 📅 2026-09-09 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 29,673 | 🐛 0 | 📅 2026-09-09 for search engines to search for papers.
