...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,524 | 🐛 106 | 📅 2026-09-02
...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 321,343 | 🐛 0 | 📅 2026-09-23 on GitHub.*
...
* [write good](https://github.com/btford/write-good) ⭐ 5,091 | 🐛 25 | 🌐 JavaScript | 📅 2025-03-10: Naive JavaScript linter for English prose.
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,413 | 🐛 215 | 🌐 TypeScript | 📅 2026-09-23 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,173 | 🐛 173 | 🌐 JavaScript | 📅 2026-09-17: Overleaf open sourced their codes. This is a great move I would say.
...
* [More](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks) ⭐ 16,784 | 🐛 1,294 | 🌐 Python | 📅 2026-09-14: For more IPython notebook on GitHub please read this enormous list.
* [Scientific Python Lectures](https://github.com/jrjohansson/scientific-python-lectures) ⭐ 3,656 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-06-02
...
* [Reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,342 | 🐛 916 | 🌐 JavaScript | 📅 2026-09-18
...
* [vim](https://github.com/vim/vim) ⭐ 40,924 | 🐛 1,633 | 🌐 Vim Script | 📅 2026-09-21(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 29,706 | 🐛 6 | 📅 2026-09-09 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 29,706 | 🐛 6 | 📅 2026-09-09 for search engines to search for papers.
