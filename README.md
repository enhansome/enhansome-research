...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,304 | 🐛 106 | 📅 2026-09-02
...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 320,638 | 🐛 0 | 📅 2026-09-19 on GitHub.*
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,368 | 🐛 185 | 🌐 TypeScript | 📅 2026-09-21 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [ReText](https://github.com/retext-project/retext) ⭐ 2,058 | 🐛 77 | 🌐 Python | 📅 2026-09-09 (`Mac`,`Win`,`Linux`): ReText one of the best, even on Linux. It also supports reStructuredText input.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,150 | 🐛 173 | 🌐 JavaScript | 📅 2026-09-17: Overleaf open sourced their codes. This is a great move I would say.
...
* [More](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks) ⭐ 16,783 | 🐛 1,292 | 🌐 Python | 📅 2026-09-14: For more IPython notebook on GitHub please read this enormous list.
* [Scientific Python Lectures](https://github.com/jrjohansson/scientific-python-lectures) ⭐ 3,655 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-06-02
...
* [mindmaps](https://github.com/drichard/mindmaps) ⭐ 2,865 | 🐛 34 | 🌐 JavaScript | 📅 2023-02-05
...
* [Reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,327 | 🐛 915 | 🌐 JavaScript | 📅 2026-09-18
...
* [Beckpoke.js](https://github.com/bespokejs/bespoke) ⭐ 4,794 | 🐛 6 | 🌐 JavaScript | 📅 2020-09-08
...
* [vim](https://github.com/vim/vim) ⭐ 40,911 | 🐛 1,629 | 🌐 Vim Script | 📅 2026-09-19(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 29,657 | 🐛 1 | 📅 2026-09-09 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 29,657 | 🐛 1 | 📅 2026-09-09 for search engines to search for papers.
