...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 318,234 | 🐛 0 | 📅 2026-09-06 on GitHub.*
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,250 | 🐛 180 | 🌐 TypeScript | 📅 2026-09-10 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,109 | 🐛 176 | 🌐 JavaScript | 📅 2026-07-10: Overleaf open sourced their codes. This is a great move I would say.
...
* [More](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks) ⭐ 16,777 | 🐛 1,282 | 🌐 Python | 📅 2026-09-07: For more IPython notebook on GitHub please read this enormous list.
...
* [Reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,280 | 🐛 916 | 🌐 JavaScript | 📅 2026-08-24
...
* [vim](https://github.com/vim/vim) ⭐ 40,882 | 🐛 1,626 | 🌐 Vim Script | 📅 2026-09-09(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 29,243 | 🐛 2 | 📅 2026-09-09 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 29,243 | 🐛 2 | 📅 2026-09-09 for search engines to search for papers.
