...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,817 | 🐛 106 | 📅 2026-09-02
...
*For self-hosted services, check out [awesome-selfhosted](https://github.com/Kickball/awesome-selfhosted) ⭐ 319,079 | 🐛 0 | 📅 2026-09-12 on GitHub.*
...
* [rtd theme](https://github.com/snide/sphinx_rtd_theme) ⭐ 5,085 | 🐛 276 | 🌐 Sass | 📅 2026-01-12: Developed by ReadtheDocs.org
...
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,295 | 🐛 194 | 🌐 TypeScript | 📅 2026-09-14 (`Node.js`): Open, Simple, non-profit; write with markdown and live preview.
...
* [ReText](https://github.com/retext-project/retext) ⭐ 2,055 | 🐛 76 | 🌐 Python | 📅 2026-09-09 (`Mac`,`Win`,`Linux`): ReText one of the best, even on Linux. It also supports reStructuredText input.
...
* [Overleaf Source Code](https://github.com/overleaf/overleaf) ⭐ 18,125 | 🐛 176 | 🌐 JavaScript | 📅 2026-07-10: Overleaf open sourced their codes. This is a great move I would say.
...
* [More](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks) ⭐ 16,781 | 🐛 1,285 | 🌐 Python | 📅 2026-09-07: For more IPython notebook on GitHub please read this enormous list.
* [Scientific Python Lectures](https://github.com/jrjohansson/scientific-python-lectures) ⭐ 3,652 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-06-02
...
* [vim](https://github.com/vim/vim) ⭐ 40,888 | 🐛 1,626 | 🌐 Vim Script | 📅 2026-09-13(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
...
* Check the [Academic Resources and Grey Literature List](https://github.com/jivoi/awesome-osint#-academic-resources-and-grey-literature) ⭐ 29,419 | 🐛 10 | 📅 2026-09-09 of the [Awesome Open-Source Intelligence List](https://github.com/jivoi/awesome-osint) ⭐ 29,419 | 🐛 10 | 📅 2026-09-09 for search engines to search for papers.
